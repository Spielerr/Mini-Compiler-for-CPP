...
IF_BLOCK
	: T_CONSTRUCT_IF T_PARAN_OPEN CONDITIONAL_STATEMENT T_PARAN_CLOSE BLOCK
	| T_CONSTRUCT_IF T_PARAN_OPEN CONDITIONAL_STATEMENT T_PARAN_CLOSE STATEMENT T_SEMI_COLON
	;
...
FOR_BLOCK
	: T_CONSTRUCT_FOR T_PARAN_OPEN STATEMENT T_SEMI_COLON CONDITIONAL_STATEMENT T_SEMI_COLON STATEMENT T_PARAN_CLOSE BLOCK
	| T_CONSTRUCT_FOR T_PARAN_OPEN STATEMENT T_SEMI_COLON CONDITIONAL_STATEMENT T_SEMI_COLON STATEMENT T_PARAN_CLOSE T_SEMI_COLON
	| T_CONSTRUCT_FOR T_PARAN_OPEN STATEMENT T_SEMI_COLON CONDITIONAL_STATEMENT T_SEMI_COLON STATEMENT T_PARAN_CLOSE STATEMENT T_SEMI_COLON
	;
...
CONDITIONAL_STATEMENT
	...
	| T_PARAN_OPEN CONDITIONAL_STATEMENT T_PARAN_CLOSE
	;
